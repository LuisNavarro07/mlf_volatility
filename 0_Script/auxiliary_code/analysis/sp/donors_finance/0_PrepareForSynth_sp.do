...
use "$cln/financial_market_volatility_sp.dta", clear
...
tsset sec_id wofd
replace sec_id = 1000 +	sec_id if sec_id>50  
...
keep sec_id wofd v* name
greshape long v, i(sec_id name wofd) j(sertype)	string
sort sec_id sertype wofd
destring sertype, replace 
/// Create Unique Ids. 
...
/// Export the Dataset 
save "${tem}\TheFilesp.dta", replace 